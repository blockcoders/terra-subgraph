...
const LUNA = "LUNA"
//const LUNA_ADDRESS = '0x320bc76961fb4e2a0e2e86d43d4b9d13b4985b8f'
...
export function handleBurn(event: BurnEvent): void {
  ...
  /*let lunaUser = User.load(LUNA_ADDRESS)
  if (lunaUser) {
    lunaUser.lunaBalance = lunaUser.lunaBalance.minus(burnAmount)
    lunaUser.save()
  }*/
  token.save()
}
